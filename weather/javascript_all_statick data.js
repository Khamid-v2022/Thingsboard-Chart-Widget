...
function draw() {
  ...
  option = {
    title: {
      text: "Weather wind direction wind speed wave forecast",
      subtext: "Sample data From www.seabreeze.com.au",
      left: "center",
    },
    tooltip: {
      trigger: "axis",
      formatter: function (params) {
        return [
          ...
          "Wave height:" + params[0].value[dims.waveHeight],
        ].join("<br>");
      },
    },
    grid: {
